...
public class elegirFoto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBuscar = findViewById(R.id.btnElegirFoto);
        btnSubir = findViewById(R.id.btnSubirFoto);
        imageView = findViewById(R.id.imgVista);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        Toast.makeText(elegirFoto.this, s , Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        //Showing toast
                        Toast.makeText(elegirFoto.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
